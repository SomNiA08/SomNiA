...
cp "$KIT/SOUL.md" "$KIT/AGENTS.md" "$KIT/TOP-WALLS.md" "$KIT/MODELS.md" "$BR/"
```
...
```bash
KIT="$(pwd)"; BR="$(cd .. && pwd)/brand-radar"
cp "$KIT/CLAUDE.md" "$BR/CLAUDE.md"
```

그다음 `$BR/CLAUDE.md`를 Edit로 세 곳 고친다.
